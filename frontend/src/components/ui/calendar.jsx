  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-7 w-7 bg-slate-900 text-white rounded-md hover:bg-blue-600 transition-colors flex items-center justify-center absolute left-1 z-10",
        button_next: "h-7 w-7 bg-slate-900 text-white rounded-md hover:bg-blue-600 transition-colors flex items-center justify-center absolute right-1 z-10",
