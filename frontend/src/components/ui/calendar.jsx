  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-8 w-8 bg-slate-900 text-white rounded-full hover:bg-blue-600 transition-colors flex items-center justify-center p-0 absolute left-2 top-1/2 -translate-y-1/2 z-10",
        button_next: "h-8 w-8 bg-slate-900 text-white rounded-full hover:bg-blue-600 transition-colors flex items-center justify-center p-0 absolute right-2 top-1/2 -translate-y-1/2 z-10",
