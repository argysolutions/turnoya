  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-8 w-8 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors flex items-center justify-center p-0 absolute left-2 top-5 -translate-y-1/2 z-10",
        button_next: "h-8 w-8 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors flex items-center justify-center p-0 absolute right-2 top-5 -translate-y-1/2 z-10",
        ...
        selected: "[&_button]:bg-blue-600 [&_button]:text-white [&_button]:font-semibold [&_button]:opacity-100 [&_button]:hover:bg-blue-700 [&_button]:hover:text-white [&_button]:transition-colors", 
        today: "[&_button]:border-2 [&_button]:border-blue-100 [&_button]:text-blue-700 [&_button]:font-semibold",
