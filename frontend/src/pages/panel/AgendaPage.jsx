    ...
    >
      <div className="space-y-6 lg:pt-2 pt-0">
        ...
        <div className="lg:hidden sticky top-0 z-[70] bg-white border-b border-slate-200 shadow-[0_4px_12px_rgba(0,0,0,0.04)] w-screen -ml-4 px-4 pt-0 pb-0">
          ...
          >
            <div className="relative flex w-full gap-0.5 px-1">
              {[
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "relative flex-1 flex-shrink-1 snap-center min-w-0 flex items-center justify-center gap-1 py-4 rounded-2xl font-black transition-all active:scale-95 z-10 px-1",
                      isActive 
